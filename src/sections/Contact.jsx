...
export default function Contact() {
  return (
    <section id="contact" className="py-16 md:py-20 bg-primary scroll-mt-24">
      ...
      <div className="max-w-3xl mx-auto px-6 text-center">
        ...
        <motion.p
          ...
          viewport={{ once: true }}
          className="text-dark text-base md:text-lg mb-8"
        >
        ...
        >
          ...
          <motion.a
            ...
            className="flex items-center justify-center gap-2 px-6 py-3 bg-secondary text-white rounded-lg font-medium shadow-md"
          >
            <FaEnvelope />
            Email Me
          </motion.a>
